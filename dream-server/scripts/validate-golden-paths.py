#!/usr/bin/env python3
"""Validate Dream Server golden-path release contracts."""
...
def validate_scenario(issues: Issues, scenario: Any, path: str) -> str | None:
    ...
    issues.require(nonempty_string(expected.get("dream_mode")), f"{path}.expected.dream_mode", "must be a non-empty string")
